...
In the Philippines, KURAP means corruption. It also means the blink of an eye—which is exactly how fast public funds can disappear into the wrong pockets. Our platform, KURAP, is the unblinking eye on public projects. We provide real-time monitoring, empower citizens to report anomalies, and arm investigators with the data they need to probe proponents. We expose the corruption that happens in a blink, because justice can't wait.      </p>
    </div>
  </div>
