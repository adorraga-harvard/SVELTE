<script lang="ts">
  // Auto-generated for Providers/mmda/metrocom/CrisisManagement.svelte
  // Endpoint type(s): tracker,map,chat-container
  export let data: any;

  $: console.log('Page Data for Providers/mmda/metrocom/CrisisManagement.svelte:', data);
