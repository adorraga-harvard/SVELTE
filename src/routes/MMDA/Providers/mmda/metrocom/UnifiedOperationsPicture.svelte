<script lang="ts">
  // Auto-generated for Providers/mmda/metrocom/UnifiedOperationsPicture.svelte
  // Endpoint type(s): map,dashboard,tracker
  export let data: any;

  $: console.log('Page Data for Providers/mmda/metrocom/UnifiedOperationsPicture.svelte:', data);
