<script lang="ts">
  // Auto-generated for Providers/mmda/metrocom/+page.svelte
  // Endpoint type(s): dashboard,map,summary
  export let data: any;

  $: console.log('Page Data for Providers/mmda/metrocom/+page.svelte:', data);
