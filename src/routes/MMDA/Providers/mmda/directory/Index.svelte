<script lang="ts">
  // Auto-generated for Providers/mmda/directory/+page.svelte
  // Endpoint type(s): dashboard,summary
  export let data: any;

  $: console.log('Page Data for Providers/mmda/directory/+page.svelte:', data);
