<script lang="ts">
  // Auto-generated for Providers/mmda/directory/OfficeLocations.svelte
  // Endpoint type(s): map,table
  export let data: any;

  $: console.log('Page Data for Providers/mmda/directory/OfficeLocations.svelte:', data);
