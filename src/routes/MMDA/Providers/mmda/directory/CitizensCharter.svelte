<script lang="ts">
  // Auto-generated for Providers/mmda/directory/CitizensCharter.svelte
  // Endpoint type(s): document_hub,report
  export let data: any;

  $: console.log('Page Data for Providers/mmda/directory/CitizensCharter.svelte:', data);
