<script lang="ts">
  // Auto-generated for Providers/mmda/resilience/FloodWaterManagement.svelte
  // Endpoint type(s): dashboard,map,settings
  export let data: any;

  $: console.log('Page Data for Providers/mmda/resilience/FloodWaterManagement.svelte:', data);
