<script lang="ts">
  // Auto-generated for Providers/mmda/resilience/+page.svelte
  // Endpoint type(s): dashboard,analytics
  export let data: any;

  $: console.log('Page Data for Providers/mmda/resilience/+page.svelte:', data);
