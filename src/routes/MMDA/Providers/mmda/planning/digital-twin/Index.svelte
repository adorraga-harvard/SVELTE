<script lang="ts">
  // Auto-generated for Providers/mmda/planning/digital-twin/+page.svelte
  // Endpoint type(s): map,analytics,dashboard
  export let data: any;

  $: console.log('Page Data for Providers/mmda/planning/digital-twin/+page.svelte:', data);
