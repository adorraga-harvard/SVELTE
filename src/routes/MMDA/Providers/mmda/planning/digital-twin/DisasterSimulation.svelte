<script lang="ts">
  // Auto-generated for Providers/mmda/planning/digital-twin/DisasterSimulation.svelte
  // Endpoint type(s): form,map,analytics
  export let data: any;

  $: console.log('Page Data for Providers/mmda/planning/digital-twin/DisasterSimulation.svelte:', data);
