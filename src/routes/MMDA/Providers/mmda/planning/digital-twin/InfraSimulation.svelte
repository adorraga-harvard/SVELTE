<script lang="ts">
  // Auto-generated for Providers/mmda/planning/digital-twin/InfraSimulation.svelte
  // Endpoint type(s): form,map,analytics
  export let data: any;

  $: console.log('Page Data for Providers/mmda/planning/digital-twin/InfraSimulation.svelte:', data);
