<script lang="ts">
  // Auto-generated for Providers/mmda/planning/ZoningAuthority.svelte
  // Endpoint type(s): map,table,document_hub
  export let data: any;

  $: console.log('Page Data for Providers/mmda/planning/ZoningAuthority.svelte:', data);
