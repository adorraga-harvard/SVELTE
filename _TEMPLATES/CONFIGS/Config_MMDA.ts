...
export const config: Route[] = [
  // SECTION 1: Metropolitan Command Center (METROCOM)
  {
    ...
    icon: "Orbit",
    end_point: "Providers/mmda/metrocom/+page.svelte",
  ...
  // SECTION 2: Mobility & Transport Command (MTC)
  {
    ...
    icon: "TramFront",
    end_point: "Providers/mmda/mobility/+page.svelte",
  ...
  // SECTION 3: Urban Resilience & Environmental Command (UREC)
  {
    ...
    icon: "Wind",
    end_point: "Providers/mmda/resilience/+page.svelte",
  ...
  // SECTION 4: Metropolitan Planning & Digital Twin Directorate
  {
    ...
    icon: "Cylinder",
    end_point: "Providers/mmda/planning/+page.svelte",
    ...
    children: [
      {
        ...
        icon: "Atom",
        end_point: "Providers/mmda/planning/digital-twin/+page.svelte",
  ...
  // SECTION 5: Directory & Citizen's Charter (Standard Fixture)
  {
    ...
    icon: "BookUser",
    end_point: "Providers/mmda/directory/+page.svelte",
